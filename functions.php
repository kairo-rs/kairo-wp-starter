<?php
/**
 * kairo functions and definitions.
 *
...
if ( ! function_exists( 'kairo_setup' ) ) :
/**
 ...
 */
function kairo_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on kairo, use a find and replace
	 * to change 'kairo' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'kairo', get_template_directory() . '/languages' );
 ...
 */
function kairo_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'kairo_content_width', 640 );
}
add_action( 'after_setup_theme', 'kairo_content_width', 0 );
 ...
 */
function kairo_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'kairo' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'kairo' ),

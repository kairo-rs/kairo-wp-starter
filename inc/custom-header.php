...
add_action( 'after_setup_theme', 'kairo_custom_header_setup' );

if ( ! function_exists( 'kairo_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see kairo_custom_header_setup().
 */
function kairo_header_style() {
